-- QA: agenda, cancela, vuelve a agendar usando contacto/contexto existente y cancela otra vez
-- scenario_key: 569900359
...
(
  gen_random_uuid(),
  '569900359',
  'TEMP QA359: book cancel rebook cancel con contacto persistente',
  'temp',
  true,
  1,
  ARRAY['temp','qa359','booking','cancel_booking','rebook','contact_context','audit','critical'],
  '[
    {
      "role":"user",
      "text":"Hola",
    ...
    },
    {
      ...
      "expect":{
        "must_have_audit":true,
        "last_bot_action_any":["collect_address","confirm_address","confirm_booking"]
      }
    },
    {
      "role":"user",
      "text":"Usa la misma direccion",
      "expect":{
        "must_have_audit":true,
        "last_bot_action_any":["confirm_address","confirm_booking","collect_address"]
      }
    },
    {
      "role":"user",
