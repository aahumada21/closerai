-- QA: agendar y luego cancelar reserva
-- scenario_key: 569900353
...
(
  gen_random_uuid(),
  '569900353',
  'TEMP QA353: book_then_cancel_end_to_end',
  'temp',
  true,
  1,
  ARRAY['temp','qa353','booking','cancel_booking','critical'],
  '[
    {
      "role":"user",
      "text":"Hola",
    ...
    },
    {
      ...
      "expect":{
        "must_have_audit":true,
        "last_bot_action_any":["cancel_booking","cancel_no_active_appointment"]
      }
    }
  ]'::jsonb,
  now(),
