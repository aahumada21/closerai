-- QA476: cotizacion inicial sin contexto no debe mostrar menu largo
-- scenario_key: 569900476
...
(
  gen_random_uuid(),
  '569900476',
  'QA476: pregunta precio lavar auto pide datos de cotizacion sin menu largo',
  'ux_sales_quote',
  true,
  1,
